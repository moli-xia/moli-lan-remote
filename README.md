...
> 以下截图中的"远程画面"为程序合成的演示桌面、设备与地址均为演示数据,
> 由 `tools/make_screenshots.py` 离屏渲染生成,不含任何真实桌面内容。

**魔力被控端 — 验证码与连接状态**

![被控端](docs/screenshots/host.png)

**魔力主控端 — 局域网设备发现**

![主控端设备发现](docs/screenshots/viewer-connect.png)

**魔力主控端 — 远程控制中**

![远程控制](docs/screenshots/viewer-session.png)
